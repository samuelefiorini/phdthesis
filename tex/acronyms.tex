...
\DeclareAcronym{NNM}{
	short = NNM,
	long  = Nuclear Norm Minimization,
	class = abbrev
}

\DeclareAcronym{MTEN}{
	short = MTEN,
	long  = Multi-task Elastic-Net,
	class = abbrev
}
...
\DeclareAcronym{CGM}{
	short = CGM,
	long  = Continuous Glucose Monitoring,
	class = abbrev
}
...
\DeclareAcronym{ARMA}{
	short = ARMA,
	long  = Autoregressive Moving Average ,
	class = abbrev
}
...
\DeclareAcronym{KRR}{
	short = KRR,
	long  = Kernel Ridge Regression,
	class = abbrev
}

\DeclareAcronym{LBGI}{
	short = LBGI,
	long  = Low Blood Glucose Index,
	class = abbrev
}

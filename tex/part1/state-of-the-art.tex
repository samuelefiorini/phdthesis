  ...
  \section{Model selection and evaluation} \label{subsec:model_selection}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}[label=(\roman*)]
        	...
        	\item homogeneity
        	\begin{equation} \label{eq:metrics_homogeneity}
        	x
        	\end{equation}
        	
        	\item completeness
        	\begin{equation} \label{eq:metrics_completeness}
        	x
        	\end{equation}
        	
        	\item v-measure
        	\begin{equation} \label{eq:metrics_v_measure}
        	x
        	\end{equation}

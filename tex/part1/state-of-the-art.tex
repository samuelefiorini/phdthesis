...
%    \end{enumerate}
	...
	Principal Component Analysis (\ac{PCA}) is probably the most popular dimensionality reduction technique. PCA is typically defined as linear projection of the data onto a lower dimensional space where the variance is maximized.

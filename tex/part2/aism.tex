...
The adopted data preprocessing strategy, namely min-max scaling, consists in casting each feature in a $[0, 1]$ range. The min-max scaling is obtained by the transformation in Equation~\eqref{eq:minmax}.

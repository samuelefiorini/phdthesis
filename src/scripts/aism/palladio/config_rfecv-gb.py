...
session_folder = 'thesis_rfecv-gb'
...
param_grid = {'classification__estimator__max_depth': map(int, np.linspace(50, 100, 30)),
              'classification__estimator__max_features': [None, 'log2', 'sqrt', 0.5],
              'classification__estimator__n_estimators': map(int, np.linspace(10, 500, 30)),

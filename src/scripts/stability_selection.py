#!/usr/bin/env python
"""Perform selection stability on the winner of the model challenge.

Given that the combination Lasso + polynomial expansion won the model challenge
(see the correspondent notebook src/notebooks/chapter6/aging_make_regression_plots.ipynb)
we perform stability selection in this case.
"""
